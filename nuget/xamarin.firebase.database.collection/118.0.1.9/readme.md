...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Database.Collection 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Database.Collection 
for Maven artifact:

artifact=com.google.firebase:firebase-database-collection 

artifact_versioned=com.google.firebase:firebase-database-collection:118.0.1

nuget=firebase-database-collection.118.0.1.9
