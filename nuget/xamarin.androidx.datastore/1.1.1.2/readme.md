...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DataStore 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DataStore 
for Maven artifact:

artifact=androidx.datastore:datastore 

artifact_versioned=androidx.datastore:datastore:1.1.1

nuget=datastore.1.1.1.2
