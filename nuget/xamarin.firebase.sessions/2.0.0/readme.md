...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Sessions 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Sessions 
for Maven artifact:

artifact=com.google.firebase:firebase-sessions 

artifact_versioned=com.google.firebase:firebase-sessions:2.0.0

nuget=firebase-sessions.2.0.0
