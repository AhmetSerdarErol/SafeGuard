...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Google.Android.Play.Integrity 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Google.Android.Play.Integrity 
for Maven artifact:

artifact=com.google.android.play:integrity 

artifact_versioned=com.google.android.play:integrity:1.4.0

nuget=integrity.1.4.0.1
