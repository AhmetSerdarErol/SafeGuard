...
`Xamarin.GoogleAndroid.Annotations` Bindings NuGet Package is a dependency of packages for
...
artifact_versioned=com.google.android:annotations:4.1.1

nuget=annotations.4.1.1.16
