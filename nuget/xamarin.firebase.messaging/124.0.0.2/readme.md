...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Messaging 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Messaging 
for Maven artifact:

artifact=com.google.firebase:firebase-messaging 

artifact_versioned=com.google.firebase:firebase-messaging:124.0.0

nuget=firebase-messaging.124.0.0.2
