...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GooglePlayServices.Auth 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GooglePlayServices.Auth 
for Maven artifact:

artifact=com.google.android.gms:play-services-auth 

artifact_versioned=com.google.android.gms:play-services-auth:121.2.0

nuget=play-services-auth.121.2.0.2
