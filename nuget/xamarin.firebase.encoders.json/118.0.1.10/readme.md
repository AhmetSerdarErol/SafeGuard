...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Encoders.JSON 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Encoders.JSON 
for Maven artifact:

artifact=com.google.firebase:firebase-encoders-json 

artifact_versioned=com.google.firebase:firebase-encoders-json:118.0.1

nuget=firebase-encoders-json.118.0.1.10
