...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GooglePlayServices.Auth.Api.Phone 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GooglePlayServices.Auth.Api.Phone 
for Maven artifact:

artifact=com.google.android.gms:play-services-auth-api-phone 

artifact_versioned=com.google.android.gms:play-services-auth-api-phone:118.1.0

nuget=play-services-auth-api-phone.118.1.0.2
