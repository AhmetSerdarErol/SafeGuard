...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Firestore 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Firestore 
for Maven artifact:

artifact=com.google.firebase:firebase-firestore 

artifact_versioned=com.google.firebase:firebase-firestore:125.0.0

nuget=firebase-firestore.125.0.0
