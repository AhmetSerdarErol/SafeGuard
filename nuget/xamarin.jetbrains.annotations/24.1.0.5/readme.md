...
JetBrains Kotlin NuGet Package Xamarin.Jetbrains.Annotations 

.NET for Android (formerly Xamarin.Android) JetBrains Kotlin bindings NuGet Package 
Xamarin.Jetbrains.Annotations  for Maven artifact:

artifact=org.jetbrains:annotations 

artifact_versioned=org.jetbrains:annotations:24.1.0

nuget=annotations.24.1.0.5
