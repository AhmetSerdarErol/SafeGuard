...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GooglePlayServices.Measurement.Api 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GooglePlayServices.Measurement.Api 
for Maven artifact:

artifact=com.google.android.gms:play-services-measurement-api 

artifact_versioned=com.google.android.gms:play-services-measurement-api:122.0.2

nuget=play-services-measurement-api.122.0.2.1
