...
`Xamarin.Grpc.Util` Bindings NuGet Package is a dependency of packages for
...
artifact=io.grpc:grpc-util 

artifact_versioned=io.grpc:grpc-util:1.59.1

nuget=grpc-util.1.59.1
