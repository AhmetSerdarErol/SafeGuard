...
JetBrains Kotlin NuGet Package Xamarin.Kotlin.StdLib.Common 

.NET for Android (formerly Xamarin.Android) JetBrains Kotlin bindings NuGet Package 
Xamarin.Kotlin.StdLib.Common  for Maven artifact:

artifact=org.jetbrains.kotlin:kotlin-stdlib-common 

artifact_versioned=org.jetbrains.kotlin:kotlin-stdlib-common:1.9.23

nuget=kotlin-stdlib-common.1.9.23.3
