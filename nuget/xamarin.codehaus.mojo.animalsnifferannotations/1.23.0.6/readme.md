...
`Xamarin.CodeHaus.Mojo.AnimalSnifferAnnotations` Bindings NuGet Package is a dependency of packages for
...
artifact_versioned=org.codehaus.mojo:animal-sniffer-annotations:1.23.0

nuget=animal-sniffer-annotations.1.23.0.6
