...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Annotation.Jvm 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Annotation.Jvm 
for Maven artifact:

artifact=androidx.annotation:annotation-jvm 

artifact_versioned=androidx.annotation:annotation-jvm:1.7.1

nuget=annotation-jvm.1.7.1.4
