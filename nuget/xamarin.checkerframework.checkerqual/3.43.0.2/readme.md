...
Xamarin.CheckerFramework.CheckerQual NuGet Package Xamarin.CheckerFramework.CheckerQual 

.NET for Android (formerly Xamarin.Android) Xamarin.CheckerFramework.CheckerQual bindings NuGet Package 
Xamarin.CheckerFramework.CheckerQual  for Maven artifact:

artifact=org.checkerframework:checker-qual 

artifact_versioned=org.checkerframework:checker-qual:3.43.0

nuget=checker-qual.3.43.0.2
