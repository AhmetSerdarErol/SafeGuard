...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GooglePlayServices.Fido 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GooglePlayServices.Fido 
for Maven artifact:

artifact=com.google.android.gms:play-services-fido 

artifact_versioned=com.google.android.gms:play-services-fido:121.1.0

nuget=play-services-fido.121.1.0.2
