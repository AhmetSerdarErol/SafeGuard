...
Google Guava NuGet Package Xamarin.Google.Guava.FailureAccess 

.NET for Android (formerly Xamarin.Android) Google Guava bindings NuGet Package 
Xamarin.Google.Guava.FailureAccess  for Maven artifact:

artifact=com.google.guava:failureaccess 

artifact_versioned=com.google.guava:failureaccess:1.0.2

nuget=failureaccess.1.0.2.5
