...
Google Guava NuGet Package Xamarin.Google.Guava 

.NET for Android (formerly Xamarin.Android) Google Guava bindings NuGet Package 
Xamarin.Google.Guava  for Maven artifact:

artifact=com.google.guava:guava 

artifact_versioned=com.google.guava:guava:33.2.0

nuget=guava.33.2.0.2
