...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Auth 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Auth 
for Maven artifact:

artifact=com.google.firebase:firebase-auth 

artifact_versioned=com.google.firebase:firebase-auth:123.0.0

nuget=firebase-auth.123.0.0
