...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Measurement.Connector 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Measurement.Connector 
for Maven artifact:

artifact=com.google.firebase:firebase-measurement-connector 

artifact_versioned=com.google.firebase:firebase-measurement-connector:120.0.1

nuget=firebase-measurement-connector.120.0.1.4
