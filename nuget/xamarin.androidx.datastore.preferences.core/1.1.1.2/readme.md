...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DataStore.Preferences.Core 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DataStore.Preferences.Core 
for Maven artifact:

artifact=androidx.datastore:datastore-preferences-core 

artifact_versioned=androidx.datastore:datastore-preferences-core:1.1.1

nuget=datastore-preferences-core.1.1.1.2
