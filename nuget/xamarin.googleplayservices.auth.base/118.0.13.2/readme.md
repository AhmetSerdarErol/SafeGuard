...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GooglePlayServices.Auth.Base 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GooglePlayServices.Auth.Base 
for Maven artifact:

artifact=com.google.android.gms:play-services-auth-base 

artifact_versioned=com.google.android.gms:play-services-auth-base:118.0.13

nuget=play-services-auth-base.118.0.13.2
