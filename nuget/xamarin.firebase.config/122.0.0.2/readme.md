...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Config 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Config 
for Maven artifact:

artifact=com.google.firebase:firebase-config 

artifact_versioned=com.google.firebase:firebase-config:122.0.0

nuget=firebase-config.122.0.0.2
