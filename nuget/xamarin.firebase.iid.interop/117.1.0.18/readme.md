...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Iid.Interop 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Iid.Interop 
for Maven artifact:

artifact=com.google.firebase:firebase-iid-interop 

artifact_versioned=com.google.firebase:firebase-iid-interop:117.1.0

nuget=firebase-iid-interop.117.1.0.18
