...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DataStore.Core.Jvm 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DataStore.Core.Jvm 
for Maven artifact:

artifact=androidx.datastore:datastore-core-jvm 

artifact_versioned=androidx.datastore:datastore-core-jvm:1.1.1

nuget=datastore-core-jvm.1.1.1.2
