...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Common.Ktx 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Common.Ktx 
for Maven artifact:

artifact=com.google.firebase:firebase-common-ktx 

artifact_versioned=com.google.firebase:firebase-common-ktx:121.0.0

nuget=firebase-common-ktx.121.0.0.2
