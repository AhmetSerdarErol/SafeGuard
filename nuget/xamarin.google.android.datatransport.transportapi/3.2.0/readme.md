...
`Xamarin.Google.Android.DataTransport.TransportApi` Bindings NuGet Package is a dependency of packages for
...
artifact=com.google.android.datatransport:transport-api 

artifact_versioned=com.google.android.datatransport:transport-api:3.2.0

nuget=transport-api.3.2.0
