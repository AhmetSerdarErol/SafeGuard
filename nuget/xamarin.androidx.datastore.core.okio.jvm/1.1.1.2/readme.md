...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DataStore.Core.OkIO.Jvm 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DataStore.Core.OkIO.Jvm 
for Maven artifact:

artifact=androidx.datastore:datastore-core-okio-jvm 

artifact_versioned=androidx.datastore:datastore-core-okio-jvm:1.1.1

nuget=datastore-core-okio-jvm.1.1.1.2
