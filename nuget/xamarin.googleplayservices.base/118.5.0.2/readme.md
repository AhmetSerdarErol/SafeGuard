...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GooglePlayServices.Base 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GooglePlayServices.Base 
for Maven artifact:

artifact=com.google.android.gms:play-services-base 

artifact_versioned=com.google.android.gms:play-services-base:118.5.0

nuget=play-services-base.118.5.0.2
