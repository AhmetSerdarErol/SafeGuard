...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GooglePlayServices.Basement 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GooglePlayServices.Basement 
for Maven artifact:

artifact=com.google.android.gms:play-services-basement 

artifact_versioned=com.google.android.gms:play-services-basement:118.4.0

nuget=play-services-basement.118.4.0.2
