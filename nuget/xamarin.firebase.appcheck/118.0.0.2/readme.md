...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.AppCheck 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.AppCheck 
for Maven artifact:

artifact=com.google.firebase:firebase-appcheck 

artifact_versioned=com.google.firebase:firebase-appcheck:118.0.0

nuget=firebase-appcheck.118.0.0.2
