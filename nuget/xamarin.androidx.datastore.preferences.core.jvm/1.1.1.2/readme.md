...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DataStore.Preferences.Core.Jvm 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DataStore.Preferences.Core.Jvm 
for Maven artifact:

artifact=androidx.datastore:datastore-preferences-core-jvm 

artifact_versioned=androidx.datastore:datastore-preferences-core-jvm:1.1.1

nuget=datastore-preferences-core-jvm.1.1.1.2
