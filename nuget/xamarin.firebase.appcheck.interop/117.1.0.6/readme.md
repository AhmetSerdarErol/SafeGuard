...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.AppCheck.Interop 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.AppCheck.Interop 
for Maven artifact:

artifact=com.google.firebase:firebase-appcheck-interop 

artifact_versioned=com.google.firebase:firebase-appcheck-interop:117.1.0

nuget=firebase-appcheck-interop.117.1.0.6
