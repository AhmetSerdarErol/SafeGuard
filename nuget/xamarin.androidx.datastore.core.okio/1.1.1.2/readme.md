...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DataStore.Core.OkIO 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DataStore.Core.OkIO 
for Maven artifact:

artifact=androidx.datastore:datastore-core-okio 

artifact_versioned=androidx.datastore:datastore-core-okio:1.1.1

nuget=datastore-core-okio.1.1.1.2
