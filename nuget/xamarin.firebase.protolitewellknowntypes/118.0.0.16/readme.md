...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.ProtoliteWellKnownTypes 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.ProtoliteWellKnownTypes 
for Maven artifact:

artifact=com.google.firebase:protolite-well-known-types 

artifact_versioned=com.google.firebase:protolite-well-known-types:118.0.0

nuget=protolite-well-known-types.118.0.0.16
