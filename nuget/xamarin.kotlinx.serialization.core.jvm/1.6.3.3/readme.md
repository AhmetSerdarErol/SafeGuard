...
JetBrains Kotlinx Coroutines NuGet Package Xamarin.KotlinX.Serialization.Core.Jvm 

.NET for Android (formerly Xamarin.Android) JetBrains Kotlinx Coroutines bindings NuGet Package 
Xamarin.KotlinX.Serialization.Core.Jvm  for Maven artifact:

artifact=org.jetbrains.kotlinx:kotlinx-serialization-core-jvm 

artifact_versioned=org.jetbrains.kotlinx:kotlinx-serialization-core-jvm:1.6.3

nuget=kotlinx-serialization-core-jvm.1.6.3.3
