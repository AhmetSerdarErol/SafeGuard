...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Google.Android.Recaptcha 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Google.Android.Recaptcha 
for Maven artifact:

artifact=com.google.android.recaptcha:recaptcha 

artifact_versioned=com.google.android.recaptcha:recaptcha:18.6.1

nuget=recaptcha.18.6.1
