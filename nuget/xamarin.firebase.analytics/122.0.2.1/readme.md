...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Analytics 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Analytics 
for Maven artifact:

artifact=com.google.firebase:firebase-analytics 

artifact_versioned=com.google.firebase:firebase-analytics:122.0.2

nuget=firebase-analytics.122.0.2.1
