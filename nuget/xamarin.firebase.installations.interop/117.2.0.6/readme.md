...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Installations.InterOp 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Installations.InterOp 
for Maven artifact:

artifact=com.google.firebase:firebase-installations-interop 

artifact_versioned=com.google.firebase:firebase-installations-interop:117.2.0

nuget=firebase-installations-interop.117.2.0.6
