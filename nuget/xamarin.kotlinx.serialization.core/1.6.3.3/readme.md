...
JetBrains Kotlinx Coroutines NuGet Package Xamarin.KotlinX.Serialization.Core 

.NET for Android (formerly Xamarin.Android) JetBrains Kotlinx Coroutines bindings NuGet Package 
Xamarin.KotlinX.Serialization.Core  for Maven artifact:

artifact=org.jetbrains.kotlinx:kotlinx-serialization-core 

artifact_versioned=org.jetbrains.kotlinx:kotlinx-serialization-core:1.6.3

nuget=kotlinx-serialization-core.1.6.3.3
