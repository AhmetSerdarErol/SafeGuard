...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Core 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Core 
for Maven artifact:

artifact=androidx.core:core 

artifact_versioned=androidx.core:core:1.13.1
