...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Common 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Common 
for Maven artifact:

artifact=com.google.firebase:firebase-common 

artifact_versioned=com.google.firebase:firebase-common:120.4.2

nuget=firebase-common.120.4.2.4
