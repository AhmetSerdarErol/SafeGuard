...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Storage 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Storage 
for Maven artifact:

artifact=com.google.firebase:firebase-storage 

artifact_versioned=com.google.firebase:firebase-storage:121.0.0

nuget=firebase-storage.121.0.0.2
