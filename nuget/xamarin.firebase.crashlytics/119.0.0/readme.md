...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Crashlytics 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Crashlytics 
for Maven artifact:

artifact=com.google.firebase:firebase-crashlytics 

artifact_versioned=com.google.firebase:firebase-crashlytics:119.0.0

nuget=firebase-crashlytics.119.0.0
