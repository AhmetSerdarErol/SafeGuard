...
JetBrains Kotlinx Coroutines NuGet Package Xamarin.KotlinX.Coroutines.Core 

.NET for Android (formerly Xamarin.Android) JetBrains Kotlinx Coroutines bindings NuGet Package 
Xamarin.KotlinX.Coroutines.Core  for Maven artifact:

artifact=org.jetbrains.kotlinx:kotlinx-coroutines-core 

artifact_versioned=org.jetbrains.kotlinx:kotlinx-coroutines-core:1.8.0

nuget=kotlinx-coroutines-core.1.8.0.4
