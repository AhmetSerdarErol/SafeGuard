...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Google.Android.Play.Core.Common 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Google.Android.Play.Core.Common 
for Maven artifact:

artifact=com.google.android.play:core-common 

artifact_versioned=com.google.android.play:core-common:2.0.4

nuget=core-common.2.0.4.2
