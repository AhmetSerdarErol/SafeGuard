...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Encoders 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Encoders 
for Maven artifact:

artifact=com.google.firebase:firebase-encoders 

artifact_versioned=com.google.firebase:firebase-encoders:117.0.0

nuget=firebase-encoders.117.0.0.18
