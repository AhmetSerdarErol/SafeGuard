...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Config.Interop 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Config.Interop 
for Maven artifact:

artifact=com.google.firebase:firebase-config-interop 

artifact_versioned=com.google.firebase:firebase-config-interop:116.0.1

nuget=firebase-config-interop.116.0.1.2
