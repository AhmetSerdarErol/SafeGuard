...
`Xamarin.JavaX.Inject` Bindings NuGet Package is a dependency of packages for
...
artifact_versioned=javax.inject:javax.inject:1.0.0

nuget=javax.inject.1.0.0.13
