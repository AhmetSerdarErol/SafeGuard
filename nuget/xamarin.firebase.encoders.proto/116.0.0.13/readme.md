...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Encoders.Proto 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Encoders.Proto 
for Maven artifact:

artifact=com.google.firebase:firebase-encoders-proto 

artifact_versioned=com.google.firebase:firebase-encoders-proto:116.0.0

nuget=firebase-encoders-proto.116.0.0.13
