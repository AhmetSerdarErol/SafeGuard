...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Annotations 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Annotations 
for Maven artifact:

artifact=com.google.firebase:firebase-annotations 

artifact_versioned=com.google.firebase:firebase-annotations:116.2.0

nuget=firebase-annotations.116.2.0.10
