...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Datatransport 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Datatransport 
for Maven artifact:

artifact=com.google.firebase:firebase-datatransport 

artifact_versioned=com.google.firebase:firebase-datatransport:119.0.0

nuget=firebase-datatransport.119.0.0.2
