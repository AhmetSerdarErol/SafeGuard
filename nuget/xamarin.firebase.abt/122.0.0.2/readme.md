...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Abt 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Abt 
for Maven artifact:

artifact=com.google.firebase:firebase-abt 

artifact_versioned=com.google.firebase:firebase-abt:122.0.0

nuget=firebase-abt.122.0.0.2
