...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DataStore.Preferences 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DataStore.Preferences 
for Maven artifact:

artifact=androidx.datastore:datastore-preferences 

artifact_versioned=androidx.datastore:datastore-preferences:1.1.1

nuget=datastore-preferences.1.1.1.2
