...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GooglePlayServices.Measurement 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GooglePlayServices.Measurement 
for Maven artifact:

artifact=com.google.android.gms:play-services-measurement 

artifact_versioned=com.google.android.gms:play-services-measurement:122.0.2

nuget=play-services-measurement.122.0.2.1
