...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GoogleAndroid.Libraries.Identity.GoogleId 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GoogleAndroid.Libraries.Identity.GoogleId 
for Maven artifact:

artifact=com.google.android.libraries.identity.googleid:googleid 

artifact_versioned=com.google.android.libraries.identity.googleid:googleid:1.1.0

nuget=googleid.1.1.0.6
