...
`Xamarin.Grpc.Android` Bindings NuGet Package is a dependency of packages for
...
artifact=io.grpc:grpc-android 

artifact_versioned=io.grpc:grpc-android:1.59.1

nuget=grpc-android.1.59.1
