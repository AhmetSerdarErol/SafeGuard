...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GooglePlayServices.CloudMessaging 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GooglePlayServices.CloudMessaging 
for Maven artifact:

artifact=com.google.android.gms:play-services-cloud-messaging 

artifact_versioned=com.google.android.gms:play-services-cloud-messaging:117.3.0

nuget=play-services-cloud-messaging.117.3.0.2
