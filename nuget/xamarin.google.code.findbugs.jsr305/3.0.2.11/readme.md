...
`Xamarin.Google.Code.FindBugs.JSR305` Bindings NuGet Package is a dependency of packages for
...
artifact_versioned=com.google.code.findbugs:jsr305:3.0.2

nuget=jsr305.3.0.2.11
