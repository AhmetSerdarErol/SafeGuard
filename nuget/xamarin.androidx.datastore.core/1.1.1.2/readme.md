...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DataStore.Core 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DataStore.Core 
for Maven artifact:

artifact=androidx.datastore:datastore-core 

artifact_versioned=androidx.datastore:datastore-core:1.1.1

nuget=datastore-core.1.1.1.2
