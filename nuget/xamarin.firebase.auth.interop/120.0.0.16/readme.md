...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Auth.Interop 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Auth.Interop 
for Maven artifact:

artifact=com.google.firebase:firebase-auth-interop 

artifact_versioned=com.google.firebase:firebase-auth-interop:120.0.0

nuget=firebase-auth-interop.120.0.0.16
