...
`Xamarin.Google.Android.DataTransport.TransportBackendCct` Bindings NuGet Package is a dependency of packages for
...
artifact=com.google.android.datatransport:transport-backend-cct 

artifact_versioned=com.google.android.datatransport:transport-backend-cct:3.3.0

nuget=transport-backend-cct.3.3.0
