...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Fragment 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Fragment 
for Maven artifact:

artifact=androidx.fragment:fragment 

artifact_versioned=androidx.fragment:fragment:1.7.0

nuget=fragment.1.7.0.2
