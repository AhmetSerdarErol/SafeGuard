...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Installations 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Installations 
for Maven artifact:

artifact=com.google.firebase:firebase-installations 

artifact_versioned=com.google.firebase:firebase-installations:118.0.0

nuget=firebase-installations.118.0.0.2
