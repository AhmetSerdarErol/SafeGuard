...
`Xamarin.Google.Android.DataTransport.TransportRuntime` Bindings NuGet Package is a dependency of packages for
...
artifact=com.google.android.datatransport:transport-runtime 

artifact_versioned=com.google.android.datatransport:transport-runtime:3.3.0

nuget=transport-runtime.3.3.0
