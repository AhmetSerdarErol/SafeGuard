...
`Xamarin.Io.PerfMark.PerfMarkApi` Bindings NuGet Package is a dependency of packages for
...
artifact_versioned=io.perfmark:perfmark-api:0.27.0

nuget=perfmark-api.0.27.0.2
