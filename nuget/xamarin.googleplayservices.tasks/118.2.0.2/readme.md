...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.GooglePlayServices.Tasks 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.GooglePlayServices.Tasks 
for Maven artifact:

artifact=com.google.android.gms:play-services-tasks 

artifact_versioned=com.google.android.gms:play-services-tasks:118.2.0

nuget=play-services-tasks.118.2.0.2
