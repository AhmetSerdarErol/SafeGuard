...
Google.Play.Services, Firebase and ML Kit (GPS-FB-MLKit) Bindings NuGet Package Xamarin.Firebase.Components 

.NET Android (formerly Xamarin.Android) GPS-FB-MLKit bindings NuGet Package Xamarin.Firebase.Components 
for Maven artifact:

artifact=com.google.firebase:firebase-components 

artifact_versioned=com.google.firebase:firebase-components:118.0.0

nuget=firebase-components.118.0.0.2
