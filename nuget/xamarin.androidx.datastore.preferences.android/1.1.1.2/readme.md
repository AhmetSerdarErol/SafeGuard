...
AndroidX Bindings NuGet Package Xamarin.AndroidX.DataStore.Preferences.Android 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.DataStore.Preferences.Android 
for Maven artifact:

artifact=androidx.datastore:datastore-preferences-android 

artifact_versioned=androidx.datastore:datastore-preferences-android:1.1.1

nuget=datastore-preferences-android.1.1.1.2
